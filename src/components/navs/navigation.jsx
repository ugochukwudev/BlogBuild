...
const Navigation = () => {
  ...
  return (
    <div>
      <nav className="relative flex mt-10 border-b-black-500 sm:mt-0 nav ml-auto mr-auto 2xl:w-6/12">
        <Link to="/">
          <img
            className="h-16 w-10 mt-10 ml-4 md:ml-4 lg:ml-16"
        ...
        <ul className=" lg:mt-16 lg:flex hidden  absolute right-4">
          ...
          <Link to="/login">
            <button className="text-base text-white font-bold bg-[#d8383a] text-center h-12 w-32 border-[#d8382A] border-8 -translate-y-3 rounded-xl mr-4">
              LOGIN
            </button>
          </Link>
        </ul>
        ...
        />
        {nav && (
          <div className=" z-50 bg-[#d8383a] w-full absolute top-0 flex flex-col items-end p-4  justify-center h-96">
            <ul className="relative">
              ...
              <Link onClick={() => unDisplayDesign()} to="/login">
                <li className="text-white font-bold text-base mb-6 ml-14 px-3 leading-normal md:ml-12 md:px-5">
                  Login
                </li>
              </Link>
